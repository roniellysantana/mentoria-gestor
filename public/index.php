...
$router->get('/alunos/editar', [AlunoController::class, 'editar']);
$router->post('/alunos/atualizar', [AlunoController::class, 'atualizar']);
$router->post('/alunos/excluir', [AlunoController::class, 'excluir']);
